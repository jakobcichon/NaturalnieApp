        ...
        labelFile.onchange = function()
        {
            ...
            else
            {
                ...
                if (fileName.indexOf('/') >= 0 || fileName.indexOf('\\') >= 0)
                    label = dymo.label.framework.openLabelFile("/Volumes/Projects/DYMO/DLS8/Projects/DLS/Common/src/sdk/JavaScriptLibrary/Samples/PreviewAndPrintLabel/File\ Folder-1245.label"); // wrong fileName under Opera/Safari, CHrome);
                else
                {
