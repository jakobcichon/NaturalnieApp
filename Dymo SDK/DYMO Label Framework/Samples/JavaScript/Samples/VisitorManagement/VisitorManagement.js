...
(function()
{
    ...
    var _layoutFiles = ["Layouts/Layout0.label", "Layouts/Layout1.label", "Layouts/Layout2.label", "Layouts/Layout3.label"];
    var _layouts = null;
    ...
    function getLayouts()
    {
        if (_layouts == null)
        {
            ...
            for (var i = 0; i < _layoutFiles.length; i++)
                result.push(dymo.label.framework.openLabelFile(replaceFileName(base, _layoutFiles[i])));
            _layouts = result;
        }
    ...
    {
        _label = dymo.label.framework.openLabelFile(replaceFileName(document.location.href, _layoutFiles[0]));
