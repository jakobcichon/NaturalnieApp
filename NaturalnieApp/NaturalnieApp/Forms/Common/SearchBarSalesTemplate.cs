...
{
    public partial class SearchBarSalesTemplate : UserControl
    {
        ...
        public SearchBarSalesTemplate(bool genButtonExist = true)
        {
            //Call setup method
            Setup();
...
/*            DoDoubleBuffered(cbProducts.Parent, true);
        ...
        public void AdjustSearchBarAppearance()
        {
            ...
            {
                this.bSearchButton.Visible = true;
                this.bSearchButton.Enabled = true;
            ...
            {
                this.bSearchButton.Visible = false;
                this.bSearchButton.Enabled = false;
...
/*                    this.ActualSelectedEnt = this.AllEntsRelation.GetFullEnt(this.cbProducts.SelectedItem.ToString());*/
        ...
        private void ShowLoadingBar()
        {
            ...
            if (this.Properties.GenButtonExist) this.bSearchButton.Enabled = false;
        ...
        private void HideLoadingBar()
        {
            ...
            if (this.Properties.GenButtonExist) this.bSearchButton.Enabled = true;
            this.IsBussy = false;
        }
